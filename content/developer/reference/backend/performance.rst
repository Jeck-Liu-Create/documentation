...
```
odoo/odoo-bin --addons-path odoo/addons,enterprise -d profilling -u base --without-demo=1
```

edit profiling.sh
```
#!/bin/bash
odoo/odoo-bin --addons-path odoo/addons,enterprise -d profilling --http-port 9100
```
make it executable
